        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              asChild
              size="lg"
              className="bg-library-gold hover:bg-library-gold/90 text-library-wood font-body shadow-golden"
            >
              <Link to="/livros">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-library-gold text-library-wood hover:bg-library-gold hover:text-library-wood font-body"
            >
              <Link to="/autores">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            <div className="group">
              ...
              <h3 className="font-heading text-2xl font-semibold text-library-gold mb-2">
                {totalBooks > 0 ? `${totalBooks}` : "..."}
              </h3>
              <p className="font-body text-library-gold/80">
                Obra{totalBooks !== 1 ? "s" : ""} Clássica
                {totalBooks !== 1 ? "s" : ""}
              </p>
            </div>
            ...
            <div className="group">
              ...
              <p className="font-body text-library-gold/80">
                Autor{totalAuthors !== 1 ? "es" : ""} Histórico
                {totalAuthors !== 1 ? "s" : ""}
              </p>
            </div>
