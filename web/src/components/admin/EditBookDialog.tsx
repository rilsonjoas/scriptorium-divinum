  ...
  useEffect(() => {
    if (book) {
      setFormData({
        ...
        publicationYearOriginal: book.publicationYearOriginal || '',
        publicationYearTranslation: book.publicationYearTranslation || 0,
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-library-parchment border-library-bronze">
        ...
        <DialogFooter>
          ...
          <Button 
            onClick={handleSave}
            disabled={isSaving || !formData.title || !formData.description || !formData.language}
