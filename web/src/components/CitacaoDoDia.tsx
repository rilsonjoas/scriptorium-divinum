      ...
      <blockquote className="max-w-3xl mx-auto rounded-lg border border-library-bronze bg-card/95 backdrop-blur-sm parchment-bg shadow-book p-8 text-center">
        ...
        {ctaUrl && (
          <a
            ...
            className="inline-flex items-center gap-2 mt-6 font-body text-sm text-library-bronze-foreground hover:text-library-crimson-foreground transition-colors"
          >
